...
(add screenshot of the home cover) (add screenshot of the Scan Sky report) (add screenshot of Scan Sky in landscape with the camera + white star overlay) (add screenshot of the NovaSaur chat) (add screenshot of a creature detail page) (add screenshot of Your Creations — the drawing studio) (add screenshot of Dino Battle) (add screenshot of a quiz) (add screenshot of the themes picker)
...
- [x] Streaming AI answers + 135-topic knowledge base (space history included), verified by a 10,000+-question harness
