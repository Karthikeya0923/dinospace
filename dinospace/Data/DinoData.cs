...
namespace dinospace.Data
{
    ...
    public static class DinoData
    {
        ...
        private static readonly Dictionary<string, string> BiteForcePsi = new()
        {
            ...
            ["Diplodocus"] = "200 PSI",
            ["Apatosaurus"] = "300 PSI",
            ["Archaeopteryx"] = "10 PSI",
            ["Microraptor"] = "20 PSI",
            ["Troodon"] = "300 PSI",
            ["Oviraptor"] = "500 PSI",
            ["Protoceratops"] = "400 PSI",
            ["Styracosaurus"] = "800 PSI",
            ["Maiasaura"] = "300 PSI",
            ["Edmontosaurus"] = "500 PSI",
            ["Carcharodontosaurus"] = "3,000 PSI",
            ["Ceratosaurus"] = "1,200 PSI",
            ["Dreadnoughtus"] = "250 PSI",
            ["Elasmosaurus"] = "1,000 PSI",
            ["Plesiosaurus"] = "800 PSI",
            ["Dimetrodon"] = "1,000 PSI",
            ["Sarcosuchus"] = "18,000 PSI",
        };
        ...
        private static List<Dinosaur> Build() => new()
        {
            ...
            new Dinosaur
            {
                ...
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The whip-tailed giant longer than two buses",
                Length = "85 feet", Height = "15 feet", Weight = "15000kg", Speed = "15km/h", Strength = 60,
                ImageFile = "diplodocus.png",
                Aliases = new[] { "diplo", "diplodocus" },
                AboutText = "Diplodocus was one of the longest dinosaurs that ever lived, stretching about as far as two school buses parked end to end. It lived around 150 million years ago in what is now western North America, where its fossils were first dug up in 1877.",
                KeyFeaturesText = "Diplodocus had an extremely long neck, an even longer whip-like tail with about 80 bones in it, and peg-shaped teeth for raking leaves off branches. Its nostrils sat high on its head.",
                LifeEnvironmentText = "Diplodocus roamed open floodplains and fern prairies dotted with conifer forests. It shared its world with Stegosaurus, Brachiosaurus and the predator Allosaurus.",
                BehaviourText = "Diplodocus likely lived in herds, sweeping its long neck side to side to strip huge areas of low-growing plants without moving its feet. Its whip tail may have been used to swat at predators and make loud cracking sounds.",
                FunFactsText = "• Diplodocus is one of the longest dinosaurs ever found as a nearly complete skeleton.\n• Its tail had around 80 bones — more than almost any other dinosaur.\n• It swallowed plants whole because it couldn't chew.\n• Famous casts of its skeleton, nicknamed Dippy, have toured museums around the world.\n• Despite its size, its head was smaller than a horse's."
            },
            new Dinosaur
            {
                Name = "Apatosaurus",
                Pronunciation = "uh-PAT-uh-saw-ruhs",
                Meaning = "Deceptive Lizard",
                Era = "Late Jurassic",
                Group = "Sauropod",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The thunder giant once called Brontosaurus",
                Length = "75 feet", Height = "15 feet", Weight = "20000kg", Speed = "15km/h", Strength = 65,
                ImageFile = "apatosaurus.png",
                Aliases = new[] { "apato", "brontosaurus", "bronto" },
                AboutText = "Apatosaurus was a massive long-necked plant-eater that lived about 150 million years ago in North America. For years many people knew it by another famous name — Brontosaurus, the 'thunder lizard' — after a mix-up between two skeletons more than a century ago.",
                KeyFeaturesText = "Apatosaurus had a thick, heavily built neck, tree-trunk legs, and a long tail that thinned into a whip. Its leg bones were some of the sturdiest of any dinosaur, built to carry the weight of several elephants.",
                LifeEnvironmentText = "It lived on the same Jurassic floodplains as Diplodocus and Stegosaurus, browsing riverside forests and open plains in what is now the western United States.",
                BehaviourText = "Apatosaurus probably moved in groups and ate almost constantly to fuel its huge body. Scientists think it could rear up briefly on its back legs to reach higher branches, using its tail for balance.",
                FunFactsText = "• Its name means 'deceptive lizard' because its bones fooled early scientists.\n• Brontosaurus and Apatosaurus were tangled up in a famous naming mix-up.\n• One thigh bone can be taller than a person.\n• It may have cracked its whip tail louder than a cannon.\n• It swallowed stones to help grind food in its stomach."
            },
            new Dinosaur
            {
                Name = "Archaeopteryx",
                ...
                Era = "Late Jurassic",
                Group = "Bird-like theropod",
                Diet = "Carnivore",
                Category = "Flying",
                ShortDescription = "The first bird — half dinosaur, half flyer",
                Length = "1.6 feet", Height = "1 foot", Weight = "1kg", Speed = "40km/h", Strength = 5,
                ImageFile = "archaeopteryx.png",
                Aliases = new[] { "archeopteryx", "first bird", "ancient wing" },
                AboutText = "Archaeopteryx is one of the most famous fossils ever found — a crow-sized animal from about 150 million years ago with the feathered wings of a bird and the teeth, claws and bony tail of a small dinosaur. It showed the world that birds are living dinosaurs.",
                KeyFeaturesText = "Archaeopteryx had true flight feathers on its wings and tail, but it also kept sharp little teeth, three clawed fingers on each wing, and a long bony tail — a perfect mix of dinosaur and bird.",
                LifeEnvironmentText = "It lived on subtropical islands in a shallow European sea, in what is now southern Germany. Its fossils were preserved in incredibly fine limestone that recorded even its feathers.",
                BehaviourText = "Archaeopteryx could probably flap and glide between trees and shorelines, snapping up insects and small animals. It likely wasn't a strong long-distance flyer like modern birds.",
                FunFactsText = "• The first Archaeopteryx skeleton was found in 1861, just two years after Darwin's famous book.\n• Its feathers are preserved in stone in beautiful detail.\n• It had teeth — no modern bird does.\n• Studies of its feathers suggest some were black.\n• It is often called the 'first bird', though it was still very much a dinosaur."
            },
            new Dinosaur
            {
                Name = "Microraptor",
                ...
                Diet = "Carnivore",
                Category = "Flying",
                ShortDescription = "The tiny glider with four wings",
                Length = "2.5 feet", Height = "1 foot", Weight = "1kg", Speed = "40km/h", Strength = 5,
                ImageFile = "microraptor.png",
                Aliases = new[] { "micro raptor", "four winged dinosaur" },
                AboutText = "Microraptor was a crow-sized cousin of Velociraptor that lived about 120 million years ago in what is now China. Amazingly, it grew long flight feathers on its legs as well as its arms — giving it four wings for gliding between trees.",
                KeyFeaturesText = "Microraptor had long feathers on both its arms and legs, a feathered tail for steering, sharp teeth and the classic raptor sickle claw. Fossil studies show its feathers shimmered glossy black, like a raven's.",
                LifeEnvironmentText = "It lived in warm, lake-dotted forests alongside early birds, mammals and countless insects. Thousands of beautifully preserved fossils come from this region's fine volcanic ash.",
                BehaviourText = "Microraptor likely climbed trees and glided from trunk to trunk, hunting insects, lizards, small mammals and even fish — remains of all of these have been found inside its fossils.",
                FunFactsText = "• Microraptor had flight feathers on its LEGS as well as its arms.\n• Its feathers were an iridescent, glossy black.\n• One fossil was found with a whole fish in its stomach.\n• It was one of the smallest known dinosaurs.\n• Hundreds of Microraptor fossils have been discovered."
            },
            new Dinosaur
            {
                Name = "Troodon",
                Pronunciation = "TROH-uh-don",
                Meaning = "Wounding Tooth",
                Era = "Late Cretaceous",
                Group = "Troodontid",
                Diet = "Omnivore",
                Category = "Land",
                ShortDescription = "One of the brainiest dinosaurs ever",
                Length = "8 feet", Height = "3 feet", Weight = "50kg", Speed = "40km/h", Strength = 25,
                ImageFile = "troodon.png",
                Aliases = new[] { "troodon formosus", "smart dinosaur" },
                AboutText = "Troodon was a slim, bird-like dinosaur from about 75 million years ago, famous for having one of the largest brains for its body size of any dinosaur. It lived across what is now North America, with fossils found from Montana to Alaska.",
                KeyFeaturesText = "Troodon had huge forward-facing eyes for excellent night vision, long slender legs, grasping hands, and a brain proportionally bigger than almost any other dinosaur's.",
                LifeEnvironmentText = "It lived in forests and plains, and some populations lived surprisingly far north, where winters were long and dark — its big eyes may have helped it hunt in dim light.",
                BehaviourText = "Troodon was quick and curious, probably hunting small animals at dusk and also eating eggs, seeds and fruit. Fossil nests show parents — possibly the fathers — brooding eggs like modern birds.",
                FunFactsText = "• For its size, Troodon had one of the biggest brains of any dinosaur.\n• Its huge eyes suggest it could hunt at night.\n• Fossil nests show it sat on its eggs like a bird.\n• Some Troodon lived in the Arctic.\n• Its name means 'wounding tooth' after its serrated teeth."
            },
            new Dinosaur
            {
                Name = "Oviraptor",
                ...
                Diet = "Omnivore",
                Category = "Land",
                ShortDescription = "The crested 'egg thief' who was really an egg protector",
                Length = "6.5 feet", Height = "3 feet", Weight = "33kg", Speed = "40km/h", Strength = 20,
                ImageFile = "oviraptor.png",
                Aliases = new[] { "egg thief", "oviraptor philoceratops" },
                AboutText = "Oviraptor was a feathered, parrot-beaked dinosaur from Mongolia's Gobi Desert, about 75 million years ago. It was named 'egg thief' because its first fossil lay on a nest of eggs — but decades later scientists realised the eggs were its OWN, and it had died protecting them.",
                KeyFeaturesText = "Oviraptor had a short toothless beak strong enough to crack shells and seeds, a showy crest on its head, feathered arms, and long legs built for speed.",
                LifeEnvironmentText = "It lived among sand dunes and seasonal streams of the Cretaceous Gobi, alongside Protoceratops and Velociraptor. Sudden collapsing dunes preserved whole nests exactly as they were.",
                BehaviourText = "Oviraptor parents sat on their nests with their feathered arms spread over the eggs, just like birds. They probably ate a mix of plants, seeds, shellfish and small animals.",
                FunFactsText = "• Oviraptor was wrongly accused of egg theft for 70 years.\n• Fossil parents have been found sitting on their nests.\n• Its beak had no teeth but could crush hard food.\n• It probably showed off its head crest like a cassowary.\n• Its arms were covered in feathers."
            },
            new Dinosaur
            {
                Name = "Protoceratops",
                Pronunciation = "pro-toh-SEH-ruh-tops",
                Meaning = "First Horned Face",
                Era = "Late Cretaceous",
                Group = "Ceratopsian",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The sheep-sized cousin of Triceratops",
                Length = "6 feet", Height = "2.5 feet", Weight = "180kg", Speed = "15km/h", Strength = 25,
                ImageFile = "protoceratops.png",
                Aliases = new[] { "proto", "first horned face" },
                AboutText = "Protoceratops was a sheep-sized plant-eater that lived in the Gobi Desert about 75 million years ago. It was an early cousin of Triceratops — it had the famous neck frill, but no long horns yet. Thousands of its fossils have been found, from hatchlings to adults.",
                KeyFeaturesText = "Protoceratops had a bony neck frill, a hooked parrot-like beak, sturdy legs, and powerful jaw muscles for slicing tough desert plants.",
                LifeEnvironmentText = "It lived in sandy dune fields with scattered shrubs and waterholes, in what is now Mongolia and northern China — the same neighbourhood as Velociraptor and Oviraptor.",
                BehaviourText = "Protoceratops likely lived in groups and dug shallow nests in the sand. One legendary fossil preserves a Protoceratops and a Velociraptor locked together mid-fight, buried by a collapsing dune.",
                FunFactsText = "• A famous fossil shows it frozen in battle with a Velociraptor.\n• Ancient people finding its skulls may have inspired griffin legends.\n• Whole nests of its babies have been found together.\n• Its beak could deliver a surprisingly nasty bite.\n• Some had bigger frills than others — maybe to impress mates."
            },
            new Dinosaur
            {
                Name = "Styracosaurus",
                Pronunciation = "sty-RAK-uh-saw-ruhs",
                Meaning = "Spiked Lizard",
                Era = "Late Cretaceous",
                Group = "Ceratopsian",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The horned dinosaur with a crown of spikes",
                Length = "18 feet", Height = "6 feet", Weight = "3000kg", Speed = "30km/h", Strength = 55,
                ImageFile = "styracosaurus.png",
                Aliases = new[] { "spiked lizard", "styraco" },
                AboutText = "Styracosaurus was a rhino-sized horned dinosaur from about 75 million years ago, in what is now Alberta, Canada. Its neck frill was ringed with four to six long spikes, making its head look like a spiky crown.",
                KeyFeaturesText = "Styracosaurus had a long nose horn up to 60 centimetres, a frill edged with dramatic spikes, a sharp beak, and a barrel-shaped body on strong legs.",
                LifeEnvironmentText = "It grazed the lush river plains and swamps of Late Cretaceous Canada, sharing its world with duck-billed dinosaurs and hungry tyrannosaurs.",
                BehaviourText = "Styracosaurus likely lived in herds — huge bone beds with many individuals have been found. The spectacular frill was probably mostly for show: recognising friends and impressing rivals.",
                FunFactsText = "• Its frill spikes could be as long as your arm.\n• Bone beds suggest it travelled in big herds.\n• Its nose horn was longer than a T. Rex tooth.\n• Like all horned dinosaurs, it sliced plants with a parrot-like beak.\n• It could probably outrun a human despite weighing as much as a car."
            },
            new Dinosaur
            {
                Name = "Maiasaura",
                Pronunciation = "my-uh-SAW-ruh",
                Meaning = "Good Mother Lizard",
                Era = "Late Cretaceous",
                Group = "Hadrosaur",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The caring duck-bill that raised its babies in nurseries",
                Length = "30 feet", Height = "8 feet", Weight = "4000kg", Speed = "25km/h", Strength = 45,
                ImageFile = "maiasaura.png",
                Aliases = new[] { "good mother lizard", "maiasaur" },
                AboutText = "Maiasaura earned its lovely name — 'good mother lizard' — when scientists in Montana found whole nesting colonies with eggs, hatchlings and adults together. It proved that some dinosaurs cared for their babies long after hatching, about 76 million years ago.",
                KeyFeaturesText = "Maiasaura was a duck-billed dinosaur with a broad flat beak, hundreds of grinding teeth, and a small bony crest between its eyes. It walked on four legs but could run on two.",
                LifeEnvironmentText = "It lived on coastal plains of western North America, nesting in huge colonies on the same grounds year after year — a site now nicknamed 'Egg Mountain'.",
                BehaviourText = "Maiasaura parents brought food to their nest-bound hatchlings, whose leg bones were too weak to walk at first. Herds of thousands migrated together for safety.",
                FunFactsText = "• Its nesting colonies held hundreds of nests just a few metres apart.\n• Hatchlings stayed in the nest while parents brought food.\n• A Maiasaura bone even flew to space with an astronaut in 1985.\n• Nest mounds were built from mud and covered with rotting plants for warmth.\n• Herds may have numbered over 10,000 animals."
            },
            new Dinosaur
            {
                Name = "Edmontosaurus",
                Pronunciation = "ed-MON-tuh-saw-ruhs",
                Meaning = "Lizard from Edmonton",
                Era = "Late Cretaceous",
                Group = "Hadrosaur",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "The duck-bill with a thousand teeth",
                Length = "39 feet", Height = "11 feet", Weight = "6000kg", Speed = "45km/h", Strength = 55,
                ImageFile = "edmontosaurus.png",
                Aliases = new[] { "edmonto", "duckbill" },
                AboutText = "Edmontosaurus was one of the biggest duck-billed dinosaurs, living right at the end of the dinosaur age, 66 to 73 million years ago, in western North America. It even shared its world with Tyrannosaurus Rex — and some fossils show healed T. Rex bite marks.",
                KeyFeaturesText = "Edmontosaurus had a wide toothless beak up front and up to a thousand small grinding teeth packed in the back of its jaws, constantly replaced as they wore down.",
                LifeEnvironmentText = "It lived in huge herds on coastal plains and river deltas, from Colorado all the way up to Alaska, munching conifer needles, twigs and flowering plants.",
                BehaviourText = "Edmontosaurus migrated in vast herds and relied on numbers and surprising speed to survive. One famous 'dinosaur mummy' fossil preserves its skin, showing pebbly scales.",
                FunFactsText = "• Some fossils preserve skin so well they're called dinosaur mummies.\n• One specimen has a healed bite from a T. Rex on its tail — it got away!\n• It packed up to 1,000 teeth into its cheeks.\n• Some herds lived in Alaska, surviving dark polar winters.\n• It could gallop about as fast as a racehorse over short bursts."
            },
            new Dinosaur
            {
                Name = "Carcharodontosaurus",
                Pronunciation = "kar-KAR-oh-don-tuh-saw-ruhs",
                Meaning = "Shark-Toothed Lizard",
                Era = "Mid Cretaceous",
                Group = "Theropod",
                Diet = "Carnivore",
                Category = "Land",
                ShortDescription = "The shark-toothed rival of T. Rex",
                Length = "40 feet", Height = "13 feet", Weight = "7000kg", Speed = "30km/h", Strength = 90,
                ImageFile = "carcharodontosaurus.png",
                Aliases = new[] { "carcharodonto", "shark toothed lizard", "carcharodontosaur" },
                AboutText = "Carcharodontosaurus was a gigantic predator from North Africa, about 95 to 100 million years ago — as long as T. Rex and named for teeth shaped like those of the great white shark. It hunted the same rivers and plains as Spinosaurus.",
                KeyFeaturesText = "It had a massive narrow skull filled with serrated, blade-like teeth up to 20 centimetres long, built for slicing rather than crushing, plus powerful legs and a long balancing tail.",
                LifeEnvironmentText = "It prowled river systems and open plains of Cretaceous North Africa, a land crowded with giant crocodiles, huge fish and long-necked sauropods to hunt.",
                BehaviourText = "Carcharodontosaurus was an ambush hunter that sliced at large prey and waited. It likely clashed with Spinosaurus at the water's edge — two giants with completely different hunting styles.",
                FunFactsText = "• Its teeth were shaped like a great white shark's.\n• It was about as long as T. Rex.\n• The first fossils were destroyed in World War II bombing.\n• Its skull alone was over 1.5 metres long.\n• It shared its habitat with Spinosaurus."
            },
            new Dinosaur
            {
                Name = "Ceratosaurus",
                Pronunciation = "seh-RAT-uh-saw-ruhs",
                Meaning = "Horned Lizard",
                Era = "Late Jurassic",
                Group = "Theropod",
                Diet = "Carnivore",
                Category = "Land",
                ShortDescription = "The horned hunter of the Jurassic",
                Length = "20 feet", Height = "8 feet", Weight = "1000kg", Speed = "30km/h", Strength = 60,
                ImageFile = "ceratosaurus.png",
                Aliases = new[] { "cerato", "horned lizard dinosaur" },
                AboutText = "Ceratosaurus was a striking meat-eater from about 150 million years ago with a blade-like horn on its nose and small horns over its eyes. It hunted in the same North American world as the bigger Allosaurus, and also turns up in Portugal and possibly Africa.",
                KeyFeaturesText = "Ceratosaurus had a nose horn, unusually long dagger teeth, tiny four-fingered arms, and a row of small bony plates running down its back — rare armour for a predator.",
                LifeEnvironmentText = "It stalked riversides and floodplain forests, possibly specialising in fish, turtles and crocodiles as well as small dinosaurs, letting it avoid competing head-on with Allosaurus.",
                BehaviourText = "Ceratosaurus was probably a lone ambush hunter. Its deep, flexible tail suggests it may even have been a decent swimmer, hunting along Jurassic rivers.",
                FunFactsText = "• It's one of the only predators with armour running down its back.\n• Its fangs were extra long for its skull size.\n• The nose horn was probably for show, not stabbing.\n• It appeared in the film Jurassic Park III.\n• It lived in the shadow of the bigger Allosaurus."
            },
            new Dinosaur
            {
                Name = "Dreadnoughtus",
                Pronunciation = "dred-NAW-tuhs",
                Meaning = "Fears Nothing",
                Era = "Late Cretaceous",
                Group = "Sauropod",
                Diet = "Herbivore",
                Category = "Land",
                ShortDescription = "A giant so complete we could weigh it",
                Length = "85 feet", Height = "30 feet", Weight = "48000kg", Speed = "10km/h", Strength = 88,
                ImageFile = "dreadnoughtus.png",
                Aliases = new[] { "dreadnought", "dreadnoughtus schrani" },
                AboutText = "Dreadnoughtus was a colossal titanosaur from Argentina, about 77 million years ago — and the most complete skeleton ever found of a super-giant dinosaur. Because so much of it was dug up, scientists could estimate its weight better than for almost any other giant.",
                KeyFeaturesText = "Dreadnoughtus had a 11-metre neck, massive pillar legs, and a muscular whip-ended tail. Its name means 'fears nothing' — a healthy adult had no predators.",
                LifeEnvironmentText = "It lived on forested floodplains in Patagonia, where rivers regularly flooded — the same floods that buried and preserved its skeleton so completely.",
                BehaviourText = "Dreadnoughtus spent nearly every waking hour eating, sweeping its long neck through the treetops. The famous skeleton was still growing when it died — it wasn't even fully grown!",
                FunFactsText = "• It's the most complete super-giant dinosaur skeleton ever found.\n• The famous specimen was STILL GROWING when it died.\n• It weighed about as much as ten elephants.\n• Its name honours the giant battleships called dreadnoughts.\n• Its shoulder blade alone was taller than a person."
            },
            new Dinosaur
            {
                Name = "Elasmosaurus",
                Pronunciation = "ee-LAZ-muh-saw-ruhs",
                Meaning = "Thin-Plate Lizard",
                Era = "Late Cretaceous",
                Group = "Plesiosaur",
                Diet = "Carnivore",
                Category = "Sea",
                ShortDescription = "The sea reptile that was half neck",
                Length = "34 feet", Height = "6 feet", Weight = "2000kg", Speed = "15km/h", Strength = 55,
                ImageFile = "elasmosaurus.png",
                Aliases = new[] { "elasmo", "long necked sea monster" },
                AboutText = "Elasmosaurus was a marine reptile whose neck made up about HALF of its entire body — around 72 bones long, more than any other animal known. It swam the great inland sea that covered the middle of North America 80 million years ago.",
                KeyFeaturesText = "Elasmosaurus had four broad flippers, a small head crammed with needle teeth, and that absurd neck, which it likely used to sneak its jaws into schools of fish without scaring them.",
                LifeEnvironmentText = "It cruised the warm, shallow Western Interior Seaway alongside giant turtles, sharks and the fearsome Mosasaurus.",
                BehaviourText = "Elasmosaurus probably hunted by drifting below schools of fish and darting its head in from a distance. It swallowed stones, perhaps for ballast or to grind food.",
                FunFactsText = "• Its neck had about 72 bones — a human has just 7.\n• The first scientist to describe it put its head on the wrong end!\n• That mistake sparked the famous 'Bone Wars' feud.\n• It couldn't lift its neck high out of the water like in old pictures.\n• It gave birth to live young at sea."
            },
            new Dinosaur
            {
                Name = "Plesiosaurus",
                Pronunciation = "PLEE-zee-uh-saw-ruhs",
                Meaning = "Near Lizard",
                Era = "Early Jurassic",
                Group = "Plesiosaur",
                Diet = "Carnivore",
                Category = "Sea",
                ShortDescription = "The four-flippered classic sea reptile",
                Length = "11 feet", Height = "3 feet", Weight = "450kg", Speed = "15km/h", Strength = 35,
                ImageFile = "plesiosaurus.png",
                Aliases = new[] { "plesiosaur", "nessie" },
                AboutText = "Plesiosaurus was the first of the long-necked sea reptiles ever discovered — dug from English sea cliffs in the 1820s by the pioneering fossil hunter Mary Anning. It lived about 195 million years ago and gave its name to the whole plesiosaur family.",
                KeyFeaturesText = "Plesiosaurus had a small head, a long flexible neck, a tubby body and four diamond-shaped flippers that it flapped like underwater wings.",
                LifeEnvironmentText = "It lived in shallow seas that covered much of Europe, hunting among reefs and open water full of ammonites, squid and fish.",
                BehaviourText = "It 'flew' through the water the way penguins and sea turtles do, picking off fish and soft-bodied prey with quick sideways snaps of its neck.",
                FunFactsText = "• It was discovered by legendary fossil hunter Mary Anning.\n• It swam by flapping four flippers like wings.\n• Its discovery amazed scientists before dinosaurs were even named.\n• Legends of lake monsters are often drawn looking like it.\n• It gave birth to live babies instead of laying eggs."
            },
            new Dinosaur
            {
                Name = "Dimetrodon",
                ...
                Diet = "Carnivore",
                Category = "Land",
                ShortDescription = "The sail-back that ruled before dinosaurs",
                Length = "11 feet", Height = "4 feet", Weight = "250kg", Speed = "15km/h", Strength = 40,
                ImageFile = "dimetrodon.png",
                Aliases = new[] { "dimetradon", "sail back" },
                AboutText = "Dimetrodon looks like a dinosaur but isn't one — it lived about 280 million years ago, tens of millions of years BEFORE the first dinosaurs, and it's actually more closely related to mammals like us. It was the top predator of its swampy world.",
                KeyFeaturesText = "Dimetrodon had a spectacular sail of skin stretched over long spine bones, a big head with two sizes of teeth — sharp fangs in front, slicing blades behind — and sprawling lizard-like legs.",
                LifeEnvironmentText = "It lived in humid swamps and river deltas in what is now Texas and Oklahoma, hunting amphibians, fish and other early reptiles.",
                BehaviourText = "The sail may have helped it warm up quickly in the morning sun, letting it hunt while slower prey were still sluggish — or it may simply have been for showing off.",
                FunFactsText = "• Dimetrodon is NOT a dinosaur — it came first, by about 50 million years.\n• It's more closely related to you than to T. Rex.\n• It was one of the first animals with different kinds of teeth.\n• Its sail may have worked like a solar panel.\n• Fossil hunters find its teeth by the bucketful in Texas."
            },
            new Dinosaur
            {
                Name = "Sarcosuchus",
                Pronunciation = "sar-koh-SOO-kuhs",
                Meaning = "Flesh Crocodile",
                Era = "Early Cretaceous",
                Group = "Crocodilian",
                Diet = "Carnivore",
                Category = "Land",
                ShortDescription = "SuperCroc — the crocodile that ate dinosaurs",
                Length = "40 feet", Height = "5 feet", Weight = "8000kg", Speed = "20km/h", Strength = 85,
                ImageFile = "sarcosuchus.png",
                Aliases = new[] { "supercroc", "super croc", "giant crocodile" },
                AboutText = "Sarcosuchus, nicknamed 'SuperCroc', was one of the largest crocodile-like animals that ever lived — about as long as a city bus. It lurked in the rivers of Africa around 110 million years ago, and it was big enough to grab dinosaurs from the bank.",
                KeyFeaturesText = "Sarcosuchus had a 1.8-metre skull with over 100 teeth, a strange bulbous bump on its snout, and armoured plates running down its whole back.",
                LifeEnvironmentText = "It ruled broad, slow rivers in what is now the Sahara — back then a green land of forests and waterways shared with fish the size of humans and Spinosaurus's relatives.",
                BehaviourText = "Like modern crocodiles, Sarcosuchus was an ambush hunter: it hung motionless near the bank, then exploded out of the water to drag prey — sometimes even dinosaurs — into the river.",
                FunFactsText = "• Its skull was as long as a tall person.\n• It kept growing throughout its whole life.\n• Growth rings in its armour suggest it lived 50-60 years.\n• Its snout bump may have boosted its sense of smell or its bellow.\n• National Geographic dubbed it 'SuperCroc' when its skeleton was unveiled."
            },
        };
    }
}
